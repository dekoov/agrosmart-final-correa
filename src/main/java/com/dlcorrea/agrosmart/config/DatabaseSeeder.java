...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (repository.count() == 0) {
            ...
            p1.setCorreNotificacion("exportaciones@agrosmart.com.ec");
            ...
            p2.setCorreNotificacion("exportaciones@agrosmart.com.ec");
            ...
            p3.setCorreNotificacion("premium@agrosmart.com.ec");
            ...
            p4.setCorreNotificacion("marketing@agrosmart.com.ec");
